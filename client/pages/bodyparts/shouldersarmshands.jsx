...
class ShouldersArmsHands extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      symptoms: null,
  ...
  componentDidMount() {
    ...
    fetch('/api/symptoms/shouldersarmshands', {
      method: 'POST',
  ...
  handleSubmit(event) {
    ...
    this.props.history.push(`/shouldersarmshandsdiagnosis/${bodyPartId}/${symptomId}`);
  }
...
export default withRouter(ShouldersArmsHands);
