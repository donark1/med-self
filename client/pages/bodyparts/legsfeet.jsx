...
class Legsfeet extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      symptoms: null,
  ...
  handleSubmit(event) {
    ...
    this.props.history.push(`/legsfeetdiagnosis/${bodyPartId}/${symptomId}`);
  }
...
export default withRouter(Legsfeet);
