...
class Headneck extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      symptoms: null,
  ...
  handleSubmit(event) {
    ...
    this.props.history.push(`/headneckdiagnosis/${bodyPartId}/${symptomId}`);
  }
...
export default withRouter(Headneck);
