...
class LegsFeetDiagnosis extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    fetch('/api/diagnosis/legsfeetdiagnosis', {
      method: 'POST',
  ...
  render() {
    ...
    return (
      <div className="container">
        <h1 className="text-center">Here are your possible legs/feet diagnosis(please select an option for suggested treatment):</h1>
...
export default withRouter(LegsFeetDiagnosis);
