...
class HeadNeckDiagnosis extends React.Component {
  ...
  handleSubmit(event) {
    ...
    this.props.history.push(`/headnecktreatments/${diagnosisId}`);
  }
  ...
  render() {
    ...
    return (
      <div className="container">
        <h1 className="text-center">Possible head/neck diagnosis<br></br>(please select for suggested treatment):</h1>
