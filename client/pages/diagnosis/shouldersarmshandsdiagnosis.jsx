...
class ShouldersArmsHandsDiagnosis extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    fetch('/api/diagnosis/shouldersarmshandsdiagnosis', {
      method: 'POST',
  ...
  handleSubmit(event) {
    ...
    this.props.history.push(`/shouldersarmshandstreatments/${symptomId}/${diagnosisId}`);
  }
  ...
  render() {
    ...
    return (
      <div className="container">
        <h1 className="text-center">Here are your possible shoulders/arms/hands diagnosis(please select an option for suggested treatment):</h1>
...
export default withRouter(ShouldersArmsHandsDiagnosis);
