...
class ChestDiagnosis extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    fetch('/api/diagnosis/chestdiagnosis', {
      method: 'POST',
  ...
  handleSubmit(event) {
    ...
    this.props.history.push(`/chesttreatments/${symptomId}/${diagnosisId}`);
  }
  ...
  render() {
    ...
    return (
      <div className="container">
        <h1 className="text-center">Here are your possible chest diagnosis(please select an option for suggested treatment):</h1>
...
export default withRouter(ChestDiagnosis);
